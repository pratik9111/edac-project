...
<div class="signup-form">
    <sf:form method="post" >
        ...
        <div class="form-group">
        	<input type="price" class="form-control" name="pricel" placeholder="price" required="required">
        </div>
		<div class="form-group">
            <input type="xDate" class="form-control" name="xDate" placeholder="xDate" required="required">
        </div>
        <div class="form-group">
            <input type="quntity" class="form-control" name="quntity" placeholder="quntity" required="required">
        </div>
